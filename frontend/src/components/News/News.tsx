...
function removeValues(string: string, list: string[], newVal: string) {
...
export default function News({ title, author, source, imageSrc, desc, link, date, bias, sentimentScore }: any) {
  const [modifiedDesc, setModifiedDesc] = useState<string>();
