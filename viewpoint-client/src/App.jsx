  ...
  */
  ...
  return (
    <>
      ...
      <h2 style={{textAlign: 'center'}}> Trending Now: 
        {
          trending ? 
          <Topics data={data} trending={trending} setTrending={setTrending} pastDate={date} 
          currentTopic={currentTopic} setCurrentTopic={setCurrentTopic}/> : <p> Loading ... </p>
        }
      ...
      {
        trending ? 
        <Calendar pastDate={date} setPastDate={setDate} date={formatDate(new Date())}/> : <p></p>
      }
