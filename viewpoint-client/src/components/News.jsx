...
export default function News( { title, author, source, imageSrc, desc, link, date, bias} ) {
            ...
            <div className={`news ${bias}Background`}> 
                <a target="_blank" href={link} className="link"> 
                    ...
                    <div className="text"> 
                        ...
                        <div className="desc">  {modifiedDesc ? 
                            (modifiedDesc.endsWith(".") ? modifiedDesc : modifiedDesc + ".") 
                            : <p> Loading... </p>} </div>

                        <hr className="line"></hr>
                        <div className="date"> {modifiedDate ? modifiedDate : <p> Loading... </p>} </div>
                    </div> 
                </a>
            </div>
        </>
